...
namespace WindowsFormsApp1
{
    ...
    public partial class Form1 : Form
    {
        ...
        static int width = pctLineXY.Width;
        static int height = pct.Height;
        bool gameStarted = false;
        bool gameCancel = false;
        int bufX;
        int bufY;
        ...
        private bool CheckWinOvert()// i - строки   j - колонки
        {
            bool win = false;
            int tmp = 0;
            for (int i = 0; i < 10; i++)
        ...
        private bool CheckWinOgoriz()// i - строки   j - колонки
        {
            bool win = false;
            int tmp = 0;
            for (int j = 0; j < 10; j++)
